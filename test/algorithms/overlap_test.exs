defmodule OverlapTest do
  ...
  test "return distance with valid arguments" do
    ...
    assert compare(%Corpus{string: "contextcontext"}, %Corpus{string: "contact"}, [ngram_size: 2]) == 0.5
    assert compare(%Corpus{string: "context"}, %Corpus{string: "contactcontact"}, [ngram_size: 2]) == 0.5
    ...
    assert compare(%Corpus{string: "night"}, %Corpus{string: "naght"}, [ngram_size: 3]) == 0.3333333333333333
