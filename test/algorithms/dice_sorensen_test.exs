defmodule DiceSorensenTest do
  ...
  test "returns nil with empty arguments" do
    assert compare(%Corpus{string: ""}, %Corpus{string: ""}, ngram_size: 1) == 0.0
    assert compare(%Corpus{string: "abc"}, %Corpus{string: ""}, ngram_size: 1) == 0.0
    assert compare(%Corpus{string: ""}, %Corpus{string: "xyz"}, ngram_size: 1) == 0.0
  ...
  test "return 1.0 with equal arguments" do
    assert compare(%Corpus{string: "a"}, %Corpus{string: "a"}, ngram_size: 1) == 1.0
    assert compare(%Corpus{string: "abc"}, %Corpus{string: "abc"}, ngram_size: 2) == 1.0
    assert compare(%Corpus{string: "123"}, %Corpus{string: "123"}, ngram_size: 3) == 1.0
  ...
  test "return 0.0 with unequal arguments" do
    assert compare(%Corpus{string: "abc"}, %Corpus{string: "xyz"}, ngram_size: 1) == 0.0
    assert compare(%Corpus{string: "123"}, %Corpus{string: "456"}, ngram_size: 2) == 0.0
    assert compare(%Corpus{string: "fff"}, %Corpus{string: "xxx"}, ngram_size: 3) == 0.0
  ...
  test "returns nil with invalid arguments" do
    assert compare(%Corpus{string: "n"}, %Corpus{string: "naght"}) == 0.0
    assert compare(%Corpus{string: "night"}, %Corpus{string: "n"}) == 0.0
    assert compare(%Corpus{string: "n"}, %Corpus{string: "naght"}, ngram_size: 2) == 0.0
    assert compare(%Corpus{string: "night"}, %Corpus{string: "n"}, ngram_size: 2) == 0.0
    assert compare(%Corpus{string: "ni"}, %Corpus{string: "naght"}, ngram_size: 3) == 0.0
  ...
  test "return distance with valid arguments" do
    ...
    assert compare(%Corpus{string: "xp"}, %Corpus{string: "nacht"}) == 0.0
