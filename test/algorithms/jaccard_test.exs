defmodule JaccardTest do
  ...
  test "return distance with valid arguments" do
    assert compare(%Corpus{string: "night"}, %Corpus{string: "nacht"}, ngram_size: 1) ==
             0.42857142857142855

    assert compare(%Corpus{string: "night"}, %Corpus{string: "naght"}, ngram_size: 1) ==
             0.6666666666666666

    assert compare(%Corpus{string: "context"}, %Corpus{string: "contact"}, ngram_size: 1) ==
             0.5555555555555556

    assert compare(%Corpus{string: "night"}, %Corpus{string: "nacht"}, ngram_size: 2) ==
             0.14285714285714285

    assert compare(%Corpus{string: "night"}, %Corpus{string: "naght"}, ngram_size: 2) ==
             0.3333333333333333
