defmodule JaccardTest do
  ...
  test "return 1 with equal arguments" do
    assert compare(%Corpus{string: "a"}, %Corpus{string: "a"}, 1) == 1
    assert compare(%Corpus{string: "abc"}, %Corpus{string: "abc"}, 2) == 1
    assert compare(%Corpus{string: "123"}, %Corpus{string: "123"}, 3) == 1
  ...
  test "return 0 with unequal arguments" do
    ...
    assert compare(%Corpus{string: "123"}, %Corpus{string: "456"}, 2) == 0
    assert compare(%Corpus{string: "fff"}, %Corpus{string: "xxx"}, 3) == 0
  ...
  test "return distance with valid arguments" do
    assert compare(%Corpus{string: "night"}, %Corpus{string: "nacht"}, 1) == 0.42857142857142855
    assert compare(%Corpus{string: "night"}, %Corpus{string: "naght"}, 1) == 0.6666666666666666

    assert compare(%Corpus{string: "context"}, %Corpus{string: "contact"}, 1) ==
             0.5555555555555556

    assert compare(%Corpus{string: "night"}, %Corpus{string: "nacht"}, 2) == 0.14285714285714285
    assert compare(%Corpus{string: "night"}, %Corpus{string: "naght"}, 2) == 0.3333333333333333

    assert compare(%Corpus{string: "context"}, %Corpus{string: "contact"}, 2) ==
             0.3333333333333333

    assert compare(%Corpus{string: "contextcontext"}, %Corpus{string: "contact"}, 2) == 0.1875
    assert compare(%Corpus{string: "context"}, %Corpus{string: "contactcontact"}, 2) == 0.1875
    ...
    assert compare(%Corpus{string: "night"}, %Corpus{string: "naght"}, 3) == 0.2
    assert compare(%Corpus{string: "context"}, %Corpus{string: "contact"}, 3) == 0.25
  end
end
