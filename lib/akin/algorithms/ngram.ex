defmodule Akin.Ngram do
  ...
  ## Examples
      iex> Akin.Ngram.compare(%Akin.Primed{string: "night"}, %Akin.Primed{string: "naght"}, 3)
      0.3333333333333333
      iex> Akin.Ngram.compare(%Akin.Primed{string: "context"}, %Akin.Primed{string: "contact"}, 1)
      0.7142857142857143
  """
