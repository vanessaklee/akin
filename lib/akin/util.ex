defmodule Akin.Util do
  ...
  @spec list_algorithms() :: list()
  @spec list_algorithms(list() | Keyword.t()) :: list()
  @spec list_algorithms(binary(), binary(), list()) :: list()
  ...
  defp list_algorithms("string", "whole", []) do
  ...
  @spec opts(keyword(), atom()) :: integer()
  @doc """
