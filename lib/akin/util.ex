defmodule Akin.Util do
  ...
  options list.
  """
  def ngram_size(opt) do
    Keyword.get(opt, :ngram_size) || Keyword.get(Akin.default_opts(), :ngram_size)
  end
  ...
  options list.
  """
  def short_length(opt) do
    Keyword.get(opt, :short_length) || Keyword.get(Akin.default_opts(), :short_length)
  end
  ...
  """
  def level(opt) do
    Keyword.get(opt, :level) || Keyword.get(Akin.default_opts(), :level)
  end
  ...
  """
  def match_at(opt) do
    Keyword.get(opt, :match_at) || Keyword.get(Akin.default_opts(), :match_at)
  end
