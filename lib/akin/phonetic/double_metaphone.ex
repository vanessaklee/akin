defmodule Akin.Metaphone.Double do
  ...
  def parse(_), do: {"", ""}
  def parse(%Double{primary_phone: primary, secondary_phone: secondary}, position, end_index, _character) when
  position > end_index
  ...
  def parse(%Double{} = metaphone, position, end_index, character) when
  character == " " do
    position = position + 1
  ...
  def process(%Double{position: position, word: %Word{start_index: start_index}} = metaphone, character)
  when character == "C" do
  ...
  def process(%Double{position: position, word: %Word{end_index: end_index}} = metaphone, character)
  when character == "L" do
  ...
  def process(%Double{position: position, word: %Word{start_index: start_index, end_index: end_index}
